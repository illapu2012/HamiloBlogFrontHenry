            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control" v-model="password">
                    </div>
                    <div class="form-group">
                        <label for="password_confirmation">Password</label>
                        <input type="url" class="form-control" v-model="password_confirmation">
                    </div>
                    <div class="col-12">
                        <div class="form-group">
                        ...
                        <br><br>
                        <p>Ya tienes una cuenta? <button @click="cambiarForm()" class="btn btn-link">Ingresa</button> </p>
                        <br><br>
                    </div>
            </div>
        </div>
