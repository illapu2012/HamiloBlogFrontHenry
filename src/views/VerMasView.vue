        ...
        <div class="row px-4">
            <div class="col-12">
                ...
                <div class="d-flex">
                    ...
                    <p class="mr-3 text-muted"><i class="fa fa-comments"></i> {{ post.cant_comentarios }}</p>
                </div>
                <p>{{ post.resumen }}</p>
            ...
            <div class="col-12 py-4">
                <div class="btn-group btn-group-lg w-100">
                    ...
                    <button @click="cambiarPost('siguiente')" type="button" class="btn btn-outline-primary">Siguiente
            ...
            <div class="col-12 py-4">
                ...
                <div v-for="coment in post.comentarios" :key="coment" class="media mb-4">
                    <img :src="'https://ui-avatars.com/api/?name=' + coment.usuario.name+ '&background=0D8ABC&color=fffs'" alt="Image" class="mr-3 mt-1 rounded-circle" style="width:60px;">
