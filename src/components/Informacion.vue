<template>
    <div class="sidebar">
            <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
                    <img class="mx-auto d-block w-75 bg-primary img-fluid rounded-circle mb-4 p-3" src="/imagen1.jpeg" alt="Image">
                    <h1 class="font-weight-bold">{{ nombre }}</h1>
                    <p class="mb-4">
                        Bienvenido a mi Blog Personal espero te guste y encuentres informacion que se de tu agrado y sea util
                    </p>
